...
const TRACK_COLOR = 0x1d2b22;
const FILL_COLOR = 0x8ddba0;

/**
 * Putt Putt loads nothing over the network — every surface is generated into the texture cache
 * here. That takes a few milliseconds rather than a few hundred, so the progress bar is really only
 * a placeholder for the moment real art is dropped in behind the same keys.
 */
