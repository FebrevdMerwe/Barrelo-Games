...
const DEFAULT_DEST = 'C:/Projects/Darts/Barrelo/external-plugins/herd-the-sheep';
...
console.log(`Deployed herd-the-sheep (protocolVersion ${manifest.protocolVersion}) to ${dest}`);
