...
if (import.meta.env.DEV && window.self === window.top) {
  ...
  const samplePayload: ClientGamePayload = {
    ...
    // `flock` is what the gameMode setting in plugin.json writes; absent it, rules.ts reads
    // 'standard' anyway, but naming it here keeps the fixture honest about the real shape.
