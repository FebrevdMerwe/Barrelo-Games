 ...
 *
 * external-plugins/ is the right destination because it is git-tracked and copied into
 * plugins/{gameId}/ on every dotnet build. src/Barrelo.Api/plugins/ is build output — anything
 * hand-dropped there is unversioned and liable to be overwritten.
 *
...
const DEFAULT_DEST = 'C:/Projects/Darts/Barrelo/external-plugins/territory';
...
console.log(`Deployed territory (protocolVersion ${manifest.protocolVersion}) to ${dest}`);
