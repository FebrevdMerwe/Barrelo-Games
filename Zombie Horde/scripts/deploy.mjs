...
const DEFAULT_DEST = 'C:/Projects/Darts/Barrelo/external-plugins/zombie-horde';
...
console.log(`Deployed ${manifest.gameId} (protocolVersion ${manifest.protocolVersion}) to ${dest}`);
